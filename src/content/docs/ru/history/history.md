...
- Автор проекта [FarySD](https://www.lanvalird.ru/projects/farysd) хотел бы добавить ферийский [на сайт сервера](https://fary.lanvalird.ru).
...
- 11.03.2026 в 9:34 (АСТР) было официально зафиксировано событие: смена локации репозитория проекта с приватного `aculaOne/ferisian_book` на публичный `lanvalird/ferisian-book` в GitHub (произошло раньше, но в истории этого нет).
